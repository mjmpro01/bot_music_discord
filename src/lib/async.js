 ...
 */
exports.asyncABC = function () { return __awaiter(void 0, void 0, void 0, function () {
    var somethingSlow, a, b, c;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                somethingSlow = function (index) {
                ...
                return [4 /*yield*/, somethingSlow(0)];
            case 1:
                a = _a.sent();
                return [4 /*yield*/, somethingSlow(1)];
            case 2:
                b = _a.sent();
                return [4 /*yield*/, somethingSlow(2)];
            case 3:
                c = _a.sent();
